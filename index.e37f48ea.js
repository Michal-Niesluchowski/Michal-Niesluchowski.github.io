...
const KEY = "78b09442-b616-49e6-9005-796e6a869504";
...
class PaginationView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (curPage === 1 && numPages > 1) return this._generateButtonNextPage(curPage + 1);
        // Last page
        if (curPage === numPages && numPages > 1) return this._generateButtonPrevPage(curPage - 1);
        // Other page
        if (curPage < numPages) return this._generateButtonNextPage(curPage + 1) + this._generateButtonPrevPage(curPage - 1);
        // Page 1 and there are no other page
        return "";
    }
    _generateButtonNextPage(pageNumber) {
        return `
      <button data-goto=${pageNumber} class="btn--inline pagination__btn--next">
    ...
    _generateButtonPrevPage(pageNumber) {
        return `
      <button data-goto=${pageNumber} class="btn--inline pagination__btn--prev">
        <svg class="search__icon">
